...
type TypedValue_StringVal struct {
	StringVal string `protobuf:"bytes,3,opt,name=string_val,json=stringVal,oneof"`
}
type TypedValue_IntVal struct {
	IntVal int64 `protobuf:"varint,4,opt,name=int_val,json=intVal,oneof"`
}
type TypedValue_UintVal struct {
	UintVal uint64 `protobuf:"varint,5,opt,name=uint_val,json=uintVal,oneof"`
}
type TypedValue_BoolVal struct {
	BoolVal bool `protobuf:"varint,6,opt,name=bool_val,json=boolVal,oneof"`
}
...
type TypedValue_FloatVal struct {
	FloatVal float32 `protobuf:"fixed32,8,opt,name=float_val,json=floatVal,oneof"`
}
type TypedValue_DecimalVal struct {
	DecimalVal *Decimal64 `protobuf:"bytes,9,opt,name=decimal_val,json=decimalVal,oneof"`
}
type TypedValue_LeaflistVal struct {
	LeaflistVal *ScalarArray `protobuf:"bytes,10,opt,name=leaflist_val,json=leaflistVal,oneof"`
}
type TypedValue_AnyVal struct {
	AnyVal *google_protobuf.Any `protobuf:"bytes,11,opt,name=any_val,json=anyVal,oneof"`
}
...
type TypedValue_AsciiVal struct {
	AsciiVal string `protobuf:"bytes,14,opt,name=ascii_val,json=asciiVal,oneof"`
}
...
type ScalarArray struct {
	// The set of elements contained within the array. It should be noted
	// that not all types within the typed value may be valid in all
	// contexts (e.g., it may be invalid to have nested ScalarArrays).
...
var fileDescriptor0 = []byte{
	...
	,
}
