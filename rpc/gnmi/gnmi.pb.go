...
type Update_JsonVal struct {
	JsonVal string `protobuf:"bytes,19,opt,name=json_val,json=jsonVal,oneof"`
}
type Update_JsonIetfVal struct {
	JsonIetfVal string `protobuf:"bytes,20,opt,name=json_ietf_val,json=jsonIetfVal,oneof"`
}
...
func (m *Update) GetJsonVal() string {
...
func (m *Update) GetJsonIetfVal() string {
...
func _Update_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Update_JsonVal:
		...
		b.EncodeStringBytes(x.JsonVal)
	case *Update_JsonIetfVal:
		b.EncodeVarint(20<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.JsonIetfVal)
...
type ScalarArray struct {
	...
	Element []*ScalarArrayValue `protobuf:"bytes,1,rep,name=element" json:"element,omitempty"`
}
...
func (m *ScalarArray) GetElement() []*ScalarArrayValue {
	if m != nil {
		return m.Element
	}
	return nil
...
// ScalarArrayValue specifies an individual element of a scalar array.
type ScalarArrayValue struct {
	// One of the fields within the value oneof may be specified
	// indicating an element included within the ScalarArray.
	//
	// Types that are valid to be assigned to Value:
	//	*ScalarArrayValue_StringVal
	//	*ScalarArrayValue_IntVal
	//	*ScalarArrayValue_UintVal
	//	*ScalarArrayValue_BoolVal
	//	*ScalarArrayValue_BytesVal
	//	*ScalarArrayValue_FloatVal
	//	*ScalarArrayValue_DecimalVal
	Value isScalarArrayValue_Value `protobuf_oneof:"value"`
}

func (m *ScalarArrayValue) Reset()                    { *m = ScalarArrayValue{} }
func (m *ScalarArrayValue) String() string            { return proto.CompactTextString(m) }
func (*ScalarArrayValue) ProtoMessage()               {}
func (*ScalarArrayValue) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }

type isScalarArrayValue_Value interface {
	isScalarArrayValue_Value()
}

type ScalarArrayValue_StringVal struct {
	StringVal string `protobuf:"bytes,1,opt,name=string_val,json=stringVal,oneof"`
}
type ScalarArrayValue_IntVal struct {
	IntVal int64 `protobuf:"varint,2,opt,name=int_val,json=intVal,oneof"`
}
type ScalarArrayValue_UintVal struct {
	UintVal uint64 `protobuf:"varint,3,opt,name=uint_val,json=uintVal,oneof"`
}
type ScalarArrayValue_BoolVal struct {
	BoolVal bool `protobuf:"varint,4,opt,name=bool_val,json=boolVal,oneof"`
}
type ScalarArrayValue_BytesVal struct {
	BytesVal []byte `protobuf:"bytes,5,opt,name=bytes_val,json=bytesVal,proto3,oneof"`
}
type ScalarArrayValue_FloatVal struct {
	FloatVal float32 `protobuf:"fixed32,6,opt,name=float_val,json=floatVal,oneof"`
}
type ScalarArrayValue_DecimalVal struct {
	DecimalVal *Decimal64 `protobuf:"bytes,7,opt,name=decimal_val,json=decimalVal,oneof"`
}

func (*ScalarArrayValue_StringVal) isScalarArrayValue_Value()  {}
func (*ScalarArrayValue_IntVal) isScalarArrayValue_Value()     {}
func (*ScalarArrayValue_UintVal) isScalarArrayValue_Value()    {}
func (*ScalarArrayValue_BoolVal) isScalarArrayValue_Value()    {}
func (*ScalarArrayValue_BytesVal) isScalarArrayValue_Value()   {}
func (*ScalarArrayValue_FloatVal) isScalarArrayValue_Value()   {}
func (*ScalarArrayValue_DecimalVal) isScalarArrayValue_Value() {}

func (m *ScalarArrayValue) GetValue() isScalarArrayValue_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *ScalarArrayValue) GetStringVal() string {
	if x, ok := m.GetValue().(*ScalarArrayValue_StringVal); ok {
		return x.StringVal
	}
	return ""
}

func (m *ScalarArrayValue) GetIntVal() int64 {
	if x, ok := m.GetValue().(*ScalarArrayValue_IntVal); ok {
		return x.IntVal
	}
	return 0
}

func (m *ScalarArrayValue) GetUintVal() uint64 {
	if x, ok := m.GetValue().(*ScalarArrayValue_UintVal); ok {
		return x.UintVal
	}
	return 0
}

func (m *ScalarArrayValue) GetBoolVal() bool {
	if x, ok := m.GetValue().(*ScalarArrayValue_BoolVal); ok {
		return x.BoolVal
	}
	return false
}

func (m *ScalarArrayValue) GetBytesVal() []byte {
	if x, ok := m.GetValue().(*ScalarArrayValue_BytesVal); ok {
		return x.BytesVal
	}
	return nil
}

func (m *ScalarArrayValue) GetFloatVal() float32 {
	if x, ok := m.GetValue().(*ScalarArrayValue_FloatVal); ok {
		return x.FloatVal
	}
	return 0
}

func (m *ScalarArrayValue) GetDecimalVal() *Decimal64 {
	if x, ok := m.GetValue().(*ScalarArrayValue_DecimalVal); ok {
		return x.DecimalVal
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ScalarArrayValue) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ScalarArrayValue_OneofMarshaler, _ScalarArrayValue_OneofUnmarshaler, _ScalarArrayValue_OneofSizer, []interface{}{
		(*ScalarArrayValue_StringVal)(nil),
		(*ScalarArrayValue_IntVal)(nil),
		(*ScalarArrayValue_UintVal)(nil),
		(*ScalarArrayValue_BoolVal)(nil),
		(*ScalarArrayValue_BytesVal)(nil),
		(*ScalarArrayValue_FloatVal)(nil),
		(*ScalarArrayValue_DecimalVal)(nil),
	}
}

func _ScalarArrayValue_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ScalarArrayValue)
	// value
	switch x := m.Value.(type) {
	case *ScalarArrayValue_StringVal:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.StringVal)
	case *ScalarArrayValue_IntVal:
		b.EncodeVarint(2<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.IntVal))
	case *ScalarArrayValue_UintVal:
		b.EncodeVarint(3<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.UintVal))
	case *ScalarArrayValue_BoolVal:
		t := uint64(0)
		if x.BoolVal {
			t = 1
		}
		...
		b.EncodeVarint(t)
	case *ScalarArrayValue_BytesVal:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		b.EncodeRawBytes(x.BytesVal)
	case *ScalarArrayValue_FloatVal:
		b.EncodeVarint(6<<3 | proto.WireFixed32)
		b.EncodeFixed32(uint64(math.Float32bits(x.FloatVal)))
	case *ScalarArrayValue_DecimalVal:
	...
	case nil:
	default:
		return fmt.Errorf("ScalarArrayValue.Value has unexpected type %T", x)
	}
	return nil
}

func _ScalarArrayValue_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ScalarArrayValue)
	switch tag {
	case 1: // value.string_val
		...
		x, err := b.DecodeStringBytes()
		m.Value = &ScalarArrayValue_StringVal{x}
		return true, err
	case 2: // value.int_val
		...
		x, err := b.DecodeVarint()
		m.Value = &ScalarArrayValue_IntVal{int64(x)}
		return true, err
	case 3: // value.uint_val
		...
		x, err := b.DecodeVarint()
		m.Value = &ScalarArrayValue_UintVal{x}
		return true, err
	case 4: // value.bool_val
		...
		x, err := b.DecodeVarint()
		m.Value = &ScalarArrayValue_BoolVal{x != 0}
		return true, err
	case 5: // value.bytes_val
		...
		x, err := b.DecodeRawBytes(true)
		m.Value = &ScalarArrayValue_BytesVal{x}
		return true, err
	case 6: // value.float_val
		...
		x, err := b.DecodeFixed32()
		m.Value = &ScalarArrayValue_FloatVal{math.Float32frombits(uint32(x))}
		return true, err
	case 7: // value.decimal_val
		...
		msg := new(Decimal64)
		err := b.DecodeMessage(msg)
		m.Value = &ScalarArrayValue_DecimalVal{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ScalarArrayValue_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ScalarArrayValue)
	// value
	switch x := m.Value.(type) {
	case *ScalarArrayValue_StringVal:
...
func init() {
	...
	proto.RegisterType((*ScalarArrayValue)(nil), "gnmi.ScalarArrayValue")
...
var fileDescriptor0 = []byte{
	...
	,
}
